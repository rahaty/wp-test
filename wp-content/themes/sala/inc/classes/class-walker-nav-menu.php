	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		foreach ( $children as $child ) {
			...
			if ( $obj[0] === 'sala_mega_menu' ) {
				$classes[]       = apply_filters( 'sala_mega_menu_css_class', 'has-mega-menu', $item, $args, $depth );
				$this->mega_menu = true;
			}
		}
		...
		if ( 'sala_mega_menu' === $item->object && defined( 'ELEMENTOR_VERSION' ) ) {
			$mega_menu_content_class = apply_filters( 'sala_mega_menu_content_css_class', 'mega-menu-content', $item, $args, $depth );
