...
if ( !class_exists('Sala_Breadcrumb') ) {

	/**
     *  Class Sala_Breadcrumb
     */
	class Sala_Breadcrumb {
		...
		public static function breadcrumb( $args = '' ) {
			...
			$default = array(
				'type'             => 'list',
				'home_label'       => esc_html__( 'Home', 'sala' ),
				'search_label'     => esc_html__( 'Search Result of "%s"', 'sala' ),
				'404_label'        => esc_html__( '404 Not Found', 'sala' ),
				'category_label'   => _x( '%s', 'category label', 'sala' ),
				'tag_label'        => _x( '%s', 'tag label', 'sala' ),
				'taxonomy_label'   => _x( '%s', 'taxonomy label', 'sala' ),
				'author_label'     => _x( '%s', 'author label', 'sala' ),
				'attachment_label' => _x( '%s', 'attachment label', 'sala' ),
				'year_label'       => _x( '%s', 'year label', 'sala' ),
				'month_label'      => _x( '%s', 'month label', 'sala' ),
				'day_label'        => _x( '%s', 'day label', 'sala' ),
				'post_type_label'  => _x( '%s', 'post type label', 'sala' ),
				'joint_string'     => esc_html__( ' &gt; ', 'sala' ),
				'navi_element'     => '',
				'elm_class'        => 'sala_breadcrumb',
				'elm_id'           => '',
				'li_class'         => '',
				'class_prefix'     => '',
			...
			$default = apply_filters( 'sala_breadcrumb_default', $default );
			...
			if ( $args['type'] == 'string' ) {
				...
				$output = apply_filters( 'sala_breadcrumb_after', $output, $args );
				...
				$output = apply_filters( 'sala_breadcrumb_before', $output, $args );
			...
			$output = apply_filters( 'sala_breadcrumb', $output, $args );
		...
		public static function get_breadcrumb_array( $args ) {
			...
			return apply_filters( 'sala_breadcrumb_arr', $breadcrumb_arr, $args );
		}
