...
class Premium_Grid extends Widget_Base {
	...
	public function get_title() {
		return sprintf( '%1$s %2$s', Helper_Functions::get_prefix(), __( 'Media Grid', 'sala' ) );
	}
	...
	protected function _register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			...
			array(
				'label'   => __( 'Grid Layout', 'sala' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'fitRows' => __( 'Even', 'sala' ),
					'masonry' => __( 'Masonry', 'sala' ),
					'metro'   => __( 'Metro', 'sala' ),
				),
				'default' => 'fitRows',
			)
		...
		$this->add_responsive_control(
			...
			array(
				...
				'mobile_default'  => '100%',
				'options'         => array(
					'100%'    => __( '1 Column', 'sala' ),
					'50%'     => __( '2 Columns', 'sala' ),
					'33.330%' => __( '3 Columns', 'sala' ),
					'25%'     => __( '4 Columns', 'sala' ),
					'20%'     => __( '5 Columns', 'sala' ),
					'16.66%'  => __( '6 Columns', 'sala' ),
					'8.33%'   => __( '12 Columns', 'sala' ),
				),
				'condition'       => array(
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Load More Button', 'sala' ),
				'description' => __( 'Requires number of images larger than 6', 'sala' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Button Text', 'sala' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'Load More', 'sala' ),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Minimum Number of Images', 'sala' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Set the minimum number of images before showing load more button', 'sala' ),
				'default'     => 6,
				'condition'   => array(
					'premium_gallery_load_more' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Images to Show', 'sala' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Set the minimum number of images to show with each click', 'sala' ),
				'default'     => 6,
				'condition'   => array(
					'premium_gallery_load_more' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => __( 'Button Alignment', 'sala' ),
		...
		$this->add_control(
			'gradient_layer',
			array(
				'label'       => __( 'Gradient Layer', 'sala' ),
				'description' => __( 'Adds a gradient color on top of the grid container', 'sala' ),
				'type'        => Controls_Manager::SWITCHER,
				'condition'   => array(
					'premium_gallery_load_more' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'First Category Label', 'sala' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'All', 'sala' ),
				'dynamic'   => array( 'active' => true ),
		...
		$repeater->add_control(
			...
			array(
				'label'       => __( 'Rotation Degrees', 'sala' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Set rotation value in degrees', 'sala' ),
				'min'         => -180,
				'max'         => 180,
				'selectors'   => array(
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Active Category Index', 'sala' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 0,
				'min'       => 0,
				'condition' => $condition,
		...
		$this->add_control(
			'active_cat_notice',
			array(
				'raw'             => __( 'Please note categories are zero indexed, so if you need the first category to be active, you need to set the value to 0', 'sala' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Shuffle Images on Filter Click', 'sala' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => array_merge(
					array(
		...
		$this->add_control(
			'url_flag',
			array(
				'label'       => __( 'URL Flag', 'sala' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => 'cat',
				'description' => __( 'This is used to link categories from different pages. For example: premiumaddons.com/grid-widget-for-elementor-page-builder?cat=2', 'sala' ),
				'label_block' => true,
				'condition'   => $condition,
			)
		);
		...
		$img_repeater->add_responsive_control(
			...
			array(
				'label'       => __( 'Width', 'sala' ),
				'description' => __( 'Works only when layout set to Metro', 'sala' ),
				'label_block' => true,
				'default'     => array(
					'unit' => 'px',
					'size' => 4,
		...
		$img_repeater->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'youtube' => __( 'YouTube', 'sala' ),
					'vimeo'   => __( 'Vimeo', 'sala' ),
					'hosted'  => __( 'Self Hosted', 'sala' ),
				),
				'label_block' => true,
				'default'     => 'youtube',
				'condition'   => array(
		...
		$img_repeater->add_control(
			...
			array(
				'label'       => __( 'Remote Video URL', 'sala' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array(
					'active' => true,
				),
		...
		$img_repeater->add_control(
			...
			array(
				'label' => __( 'Get Title/Description From Media Library', 'sala' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		...
		$img_repeater->add_control(
			...
			array(
				'label'       => __( 'Category', 'sala' ),
				'type'        => Controls_Manager::TEXT,
				'description' => __( 'To assign for multiple categories, separate by a comma \',\'', 'sala' ),
				'dynamic'     => array( 'active' => true ),
			)
		);
		...
		$img_repeater->add_control(
			...
			array(
				'label'       => __( 'Link Type', 'sala' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'url'  => __( 'URL', 'sala' ),
					'link' => __( 'Existing Page', 'sala' ),
				),
				'default'     => 'url',
				'label_block' => true,
				'condition'   => array(
		...
		$img_repeater->add_control(
			...
			array(
				'label'     => __( 'Whole Image Link', 'sala' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => array(
					'premium_gallery_video!' => 'true',
				),
		...
		$img_repeater->add_control(
			...
			array(
				'label'     => __( 'Whole Image Lightbox', 'sala' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => array(
					'premium_gallery_video!' => 'true',
				),
		...
		$this->add_control(
			...
			array(
				'label' => __( 'Shuffle Images on Page Load', 'sala' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Youtube Videos Thumbnail Size', 'sala' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'maxresdefault' => __( 'Maximum Resolution', 'sala' ),
					'hqdefault'     => __( 'High Quality', 'sala' ),
					'mqdefault'     => __( 'Medium Quality', 'sala' ),
					'sddefault'     => __( 'Standard Quality', 'sala' ),
				),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Skin', 'sala' ),
				'type'        => Controls_Manager::SELECT,
				'description' => __( 'Choose a layout style for the gallery', 'sala' ),
				'options'     => array(
					'default' => __( 'Style 1', 'sala' ),
					'style1'  => __( 'Style 2', 'sala' ),
					'style2'  => __( 'Style 3', 'sala' ),
					'style3'  => __( 'Style 4', 'sala' ),
				),
				'default'     => 'default',
				'separator'   => 'before',
				'label_block' => true,
		...
		$this->add_control(
			...
			array(
				'raw'             => __( 'Style 4 works only with Even / Masonry Layout', 'sala' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Hover Effect', 'sala' ),
				'type'        => Controls_Manager::SELECT,
				'description' => __( 'Choose a hover effect for the image', 'sala' ),
				'options'     => array(
					'none'    => __( 'None', 'sala' ),
					'zoomin'  => __( 'Zoom In', 'sala' ),
					'zoomout' => __( 'Zoom Out', 'sala' ),
					'scale'   => __( 'Scale', 'sala' ),
					'gray'    => __( 'Grayscale', 'sala' ),
					'blur'    => __( 'Blur', 'sala' ),
					'bright'  => __( 'Bright', 'sala' ),
					'sepia'   => __( 'Sepia', 'sala' ),
					'trans'   => __( 'Translate', 'sala' ),
				),
				'default'     => 'zoomin',
				'label_block' => true,
				'separator'   => 'after',
		...
		$this->add_control(
			...
			array(
				'label'        => __( 'Always Show Play Icon', 'sala' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'true',
				'default'      => 'true',
				'condition'    => array(
		...
		$this->add_control(
			...
			array(
				'label'   => __( 'Videos Play Icon', 'sala' ),
				'type'    => Controls_Manager::ICONS,
				'default' => array(
					'library' => 'fa-solid',
					'value'   => 'fas fa-play',
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'RTL Mode', 'sala' ),
				'description' => __( 'This option moves the origin of the grid to the right side. Useful for RTL direction sites', 'sala' ),
				'type'        => Controls_Manager::SWITCHER,
				'separator'   => 'before',
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => __( 'Content Alignment', 'sala' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'left'   => array(
						'title' => __( 'Left', 'sala' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Lightbox Style', 'sala' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'default',
				'options'   => array(
					'default' => __( 'PrettyPhoto', 'sala' ),
					'yes'     => __( 'Elementor', 'sala' ),
					'no'      => __( 'Other Lightbox Plugin', 'sala' ),
				),
				'condition' => array(
		...
		$this->add_control(
			'lightbox_show_title',
			array(
				'label'     => __( 'Show Image Title', 'sala' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'condition' => array(
					'premium_gallery_light_box'     => 'yes',
		...
		$this->add_control(
			...
			array(
				'raw'             => __( 'Please note Elementor lightbox style is always applied on videos.', 'sala' ),
				'type'            => Controls_Manager::RAW_HTML,
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Lightbox Theme', 'sala' ),
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'pp_default'    => __( 'Default', 'sala' ),
					'light_rounded' => __( 'Light Rounded', 'sala' ),
					'dark_rounded'  => __( 'Dark Rounded', 'sala' ),
					'light_square'  => __( 'Light Square', 'sala' ),
					'dark_square'   => __( 'Dark Square', 'sala' ),
					'facebook'      => __( 'Facebook', 'sala' ),
				),
				'default'   => 'pp_default',
				'condition' => array(
					'premium_gallery_light_box'     => 'yes',
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Overlay Gallery Images', 'sala' ),
				'type'      => Controls_Manager::SWITCHER,
				'condition' => array(
					'premium_gallery_light_box'     => 'yes',
					'premium_gallery_lightbox_type' => 'default',
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Responsive Controls', 'sala' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => __( 'If the content text is not suiting well on specific screen sizes, you may enable this option which will hide the description text.', 'sala' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Minimum Size', 'sala' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Note: minimum size for extra small screens is 1px.', 'sala' ),
				'default'     => 1,
				'condition'   => array(
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Maximum Size', 'sala' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => __( 'Note: maximum size for extra small screens is 767px.', 'sala' ),
				'default'     => 767,
				'condition'   => array(
					'premium_gallery_responsive_switcher' => 'yes',
				),
		...
		$this->start_controls_section(
			'section_pa_docs',
			array(
				'label' => __( 'Helpful Documentations', 'sala' ),
			)
		);

		$docs = array(
			'https://premiumaddons.com/docs/grid-widget-tutorial' => __( 'Getting started »', 'sala' ),
			'https://premiumaddons.com/docs/how-to-assign-an-image-to-multiple-categories' => __( 'How to assign a grid item to multiple categories »', 'sala' ),
			'https://premiumaddons.com/docs/how-to-link-categories-in-elementor-gallery-widget/' => __( 'How To Link Categories In Media Grid Widget »', 'sala' ),
			'https://premiumaddons.com/docs/how-to-open-a-popup-lightbox-through-a-grid-image' => __( 'How to open an Elementor popup/lightbox using a grid item »', 'sala' ),
			'https://premiumaddons.com/docs/how-to-solve-media-grid-and-tabs-widgets-conflict/'  => __( 'How to Solve Media Grid and Tabs Widgets Conflict »', 'sala' ),
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Hover Overlay Color', 'sala' ),
		...
		$this->add_group_control(
			Group_Control_Css_Filter::get_type(),
			array(
				'label'    => __( 'Hover CSS Filters', 'sala' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => __( 'Title / Description', 'sala' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Text Hover Color', 'sala' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => array(
					'type'  => Color::get_type(),
					'value' => Color::COLOR_2,
