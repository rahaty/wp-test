...
class Modify_Widget_Section extends Modify_Base {
	...
	public function section_layout( $element ) {
		...
		$section_gap['options'] = [
			...
			'default'  => esc_html__( 'Normal', 'sala' ),
			'no'       => esc_html__( 'No Gap', 'sala' ),
			'narrow'   => esc_html__( 'Narrow', 'sala' ),
			'extended' => esc_html__( 'Extended', 'sala' ),
			'wide'     => esc_html__( 'Wide', 'sala' ),
			'wider'    => esc_html__( 'Wider', 'sala' ),
		...
		$element->add_control( 'gap_beside', [
			'label'        => esc_html__( 'Gap Beside', 'sala' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'yes',
			'options'      => [
				'no'  => esc_html__( 'No', 'sala' ),
				'yes' => esc_html__( 'Yes', 'sala' ),
			],
		...
		$element->add_responsive_control( 'gap_width', [
			'label'     => esc_html__( 'Gap Width', 'sala' ),
		...
		$element->add_control( 'column_vertical_alignment', [
			'label'                => esc_html__( 'Column Vertical Alignment', 'sala' ),
			'label_block'          => true,
			'type'                 => Controls_Manager::CHOOSE,
