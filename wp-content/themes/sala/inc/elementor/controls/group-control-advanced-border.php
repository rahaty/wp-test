...
class Group_Control_Advanced_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['type'] = [
			'label'     => _x( 'Type', 'Border Control', 'sala' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __( 'Default', 'sala' ),
				'none'   => __( 'None', 'sala' ),
				'solid'  => _x( 'Solid', 'Border Control', 'sala' ),
				'double' => _x( 'Double', 'Border Control', 'sala' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'sala' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'sala' ),
				'groove' => _x( 'Groove', 'Border Control', 'sala' ),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x( 'Color', 'Border Control', 'sala' ),
		...
		$fields['width'] = [
			'label'      => _x( 'Width', 'Border Control', 'sala' ),
		...
		$fields['radius'] = [
			'label'      => _x( 'Rounded', 'Border Control', 'sala' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Border', 'Advanced Border Control', 'sala' ),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
