(
	function( $ ) {
		...
		var CircleProgressChartHandler = function( $scope, $ ) {
			var $element = $scope.find( '.sala-circle-progress-chart' );
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/sala-circle-progress-chart.default', CircleProgressChartHandler );
		} );
	}
)( jQuery );
