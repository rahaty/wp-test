(
	function( $ ) {
		...
		var SwiperHandler = function( $scope, $ ) {
			var $slider = $scope.find( '.sala-slider-widget' );
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/sala-product-carousel-countdown.default', SwiperHandler );
		} );
	}
)( jQuery );
