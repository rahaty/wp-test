<?php
$section = 'page_title_01';
$prefix  = 'page_title_01_';

Sala_Kirki::add_section( $section , array(
	'title' => esc_attr__( 'Style 01', 'sala' ),
	'panel' => $panel,
) );
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'          => array(
		array(
			'element' => '.page-title-01 .page-title-bg',
		),
	),
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-01 .page-title-bg:before',
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.page-title-01 .page-title-inner',
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'  => '.page-title.page-title-01',
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.page-title-01 .sala_breadcrumb li, .page-title-01 .sala_breadcrumb li a',
		),
	),
) );
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-01 .sala_breadcrumb li',
			'property' => 'color',
		),
	),
) );
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.page-title-01 .sala_breadcrumb a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.page-title-01 .sala_breadcrumb a:hover',
			'property' => 'color',
		),
	),
) );
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-title-01 .sala_breadcrumb li + li:before',
			'property' => 'color',
		),
	),
) );
...
Sala_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'element'     => '.page-title-01 .page-title-inner .heading',
			'property'    => 'font-size',
			'units'       => 'px',
