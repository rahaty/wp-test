				...
				$heading .='<div class="vertical-divider top"> </div>';
					...
					if($heading_style =="style_1" ){
						...
						if($settings["sub_title"] !=""){
							...
							$s_title_con .='<'.esc_attr(theplus_validate_html_tag($settings["sub_title_tag"])).' class="heading-sub-title '.esc_attr($mobile_center).' '.$sub_gradient_cass.'"> '.$sub_title_dis.' </'.esc_attr(theplus_validate_html_tag($settings["sub_title_tag"])).'>';
							$s_title_con .='</div>';
						}
