			...
			if ($image_banner == 'banner_img'){
					if($display_banner_image =='yes'){
						...
						if($video_type=='youtube'){
							...
							$video_content .='<div class="ts-video-wrapper embed-container  ts-type-'.esc_attr($video_type).'"><iframe id="'.$uid.'" src="https://player.vimeo.com/video/'.$vimeo_id.'?html5=1&amp;title=0&amp;byline=0&amp;portrait=0&amp;'.$vimeo_frame_attr.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';
						}else if($video_type=='self-hosted'){
